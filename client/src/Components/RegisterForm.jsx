...
const RegisterForm = () => {
  ...
  return (
    <div style={bgStyle}>
    <div className='absolute mt-44 left-1/3 border m-4 p-8 w-1/3 bg-black bg-opacity-30 rounded-lg'>
      <h2 className='text-center mb-10 text-5xl font-bold text-white'>Register</h2>
      <form className='space-y-5'>
        ...
        <div className='flex flex-col space-y-2'>
          ...
          <input type="email" value={email} onChange={handleEmailChange} placeholder="Enter your Email" className='border border-slate-500 rounded-md p-2 bg-white bg-opacity-20 text-white'/>
        </div>
        <div >
          <label className='text-white text-3xl mr-3'>Role:</label>
          <select value={role} onChange={handleRoleChange} className = "p-2 rounded-lg">
        ...
        <div>
        <a href='/login' className='text-blue-800 text-md'>Already Registered?</a>
        </div>
